...
description: Identify super-enhancers from H3K27ac ChIP-seq data using ROSE and related tools. Distinguish regulatory elements controlling cell identity.
tool_type: cli
primary_tool: ROSE
---
