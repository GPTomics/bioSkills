...
description: Parse and write protein structure files using Biopython Bio.PDB. Use for reading PDB, mmCIF, and MMTF files, downloading structures from RCSB PDB, extracting header information, and writing structures to various formats.
tool_type: python
