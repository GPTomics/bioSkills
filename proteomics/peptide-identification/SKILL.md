...
description: Peptide-spectrum matching and protein identification from MS/MS data. Covers database searching, spectral library matching, and FDR estimation using target-decoy approaches.
tool_type: mixed
