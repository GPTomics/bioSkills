...
description: Search NCBI databases using Biopython Bio.Entrez. Use for finding records by keyword, building search queries, discovering database structure, and getting global query counts across databases.
tool_type: python
