...
description: End-to-end ChIP-seq workflow from FASTQ files to annotated peaks. Covers QC, alignment, peak calling with MACS3, and peak annotation with ChIPseeker.
tool_type: mixed
primary_tool: MACS3, ChIPseeker
workflow: true
depends_on:
